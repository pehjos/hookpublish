...
{user?
(<div className="child">
<Avatar onClick={openPost}  style={{width:80,height:80,}} alt={user.result.user?.displayName} src={user.result.user?.photoURL}>
{user.result.user?.displayName.charAt(0)}
</Avatar>
<ExitToAppOutlined onClick={auth}/>
</div>):
(<div className="child">
<Link to="/auth">
<p>Sign In</p>
